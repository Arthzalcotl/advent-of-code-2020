<?php
  ...
  */
  ...
  foreach($temp_arr2 as $ta2){
    $total += count(array_unique(str_split(str_replace(' ', '', $ta2))));
  }
  echo $total;
  ...
  */
  $total = 0;
  foreach($temp_arr2 as $ta2){
    $temp_arr3 = explode(' ', $ta2);
    $member = count($temp_arr3);

    $temp_arr4 = count_chars(str_replace(' ', '', $ta2), 1);
    rsort($temp_arr4);
